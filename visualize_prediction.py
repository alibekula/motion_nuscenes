...
def main() -> None:
    ...
    parser.add_argument("--xlim", type=float, default=45.0)
    parser.add_argument("--ylim", type=float, default=45.0)
    ...
    ax.set_title(
        f"sample {args.sample_index} | agent {agent_idx} ({token}) | top modes {mode_text}",
        fontsize=10,
        pad=10,
    )
